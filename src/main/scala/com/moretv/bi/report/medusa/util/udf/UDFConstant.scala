...
object UDFConstant {
  ...
  val MoretvPageDetailInfo = Array("search","hot_jiaodian","1_hot_tag_xinwenredian","hot_zhuanti",
    ...
    "movie_yazhou","movie_lengmen","1_movie_tag_dongzuo","1_movie_tag_kehuan","movie_yueyu","collect","tv_genbo","tv_cqz",
  ...
  val MedusaPageDetailInfo = Array(
    ...
    "动画电影","好莱坞巨制","华语精选","日韩亚太","冷门佳片","犀利动作","科学幻想","粤语佳片","重磅追剧","午夜场","楚乔传",
    "华语热播","电视剧专题","卫视常青剧", "抗战风云","剧星专区","香港TVB","韩剧热流","10亿俱乐部","仙侠玄幻","大陆剧场","特色美剧","长剧欣赏",
    "日剧集锦","台湾剧集","英伦佳剧","其他地区","粤语专区","猜你喜欢","经典重温","最强暑期档","电视原声","海外同步","奔跑吧","家庭伦理","都市情感",
