...
object UDFConstant {
  ...
  val MoretvPageDetailInfo = Array("search","hot_jiaodian","1_hot_tag_xinwenredian","hot_zhuanti","jilu_teji",
    ...
    "tv_free","tv_paihang","tv_gaofen","tv_wangju","mengwa_zongyi","jixiantiaozhan_zongyi","jilu_vip")
  ...
  val MedusaPageDetailInfo = Array(
    ...
    "青春浪漫","励志治愈","奇幻魔法","悬疑推理","其他分类","国漫精选","名作之壁","二次元","次元经典","游戏竞技","人物特辑",
    ...
    "爆笑喜剧","麻辣泰剧", "百看不厌","热播排行","豆瓣高分","超级网剧", "极限挑战","萌娃宝贝","青春偶像","家庭情感","独家策划","VIP纪实")
