...
object KidsEachTabViewInfo extends BaseClass{
  ...
  private val regex_kandonghua = ("(kandonghua|kids_anim)*(动画明星|热播推荐|最新出炉|动画专题|欧美精选|国产精选|0-3岁|" +
    "4-6岁|7-10岁|英文动画|少儿电影|儿童综艺|亲子交流|益智启蒙|童话故事|教育课堂|搞笑|机战|亲子|探险|最佳短片|猫猫优选|爱看动漫|尼克动画)").r
  private val regex_tingerge = ("(tingerge|kids_rhymes)*(随便听听|儿歌明星|儿歌热播|儿歌专辑|英文儿歌|舞蹈律动|尼克动画)").r
