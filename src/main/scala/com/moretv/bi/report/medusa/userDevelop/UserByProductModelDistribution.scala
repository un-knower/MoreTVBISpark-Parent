 ...
 */
object UserByProductModelDistribution extends BaseClass {
  private val tableName = "medusa_user_product_model_distribution"
  private val insertSql = s"insert into ${tableName}(day,product_model,new_user_num,total_user_num) values (?,?,?,?)"
