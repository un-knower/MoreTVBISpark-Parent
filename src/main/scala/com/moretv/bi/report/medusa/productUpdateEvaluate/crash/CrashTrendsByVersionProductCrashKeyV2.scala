    ...
    ParamsParseUtil.parse(args) match {
      case Some(p) =>{
        ...
        "APP_VERSION_CODE","CRASH_KEY","STACK_TRACE","DATE_CODE","PRODUCT_CODE").map(e=>(e.getString(0),
          e.getString(1),e.getString(2),
        e.getString(3),e.getString(4),e.getString(5),e.getString(6))).filter(e=>{e._2!=null}).map(e=>(e._1,
          e._2.replace(":",""),e._3, e._4,e._5,e._6,e._7)).filter(e=>{e._5!=null && e._5!=""  && {if(e._6!=null) e._6.length<=20 else true}})
