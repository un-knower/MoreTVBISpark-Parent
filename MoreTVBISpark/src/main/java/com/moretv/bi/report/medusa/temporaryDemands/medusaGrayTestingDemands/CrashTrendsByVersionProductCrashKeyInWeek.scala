...
object CrashTrendsByVersionProductCrashKeyInWeek extends SparkSetting{
  ...
  def main(args: Array[String]) {
    ParamsParseUtil.parse(args) match {
      case Some(p) =>{
        ...
        val logRdd = sc.textFile(s"/log/crash/metadata/201606{07,08,09,10,11,12,13}_extraction.log").map(log=>{
        ...
        /*insert sql*/
        val sqlInsert = "insert into medusa_gray_testing_crash_info_temp(day," +
        ...
        versionProductOutofmemoryRdd.foreach(r=>{
          util.insert(sqlInsert,"20160607-20160613",r._2,r._3,r._1,"OOM",new JLong(r._4),new JLong(r._5))
        })
        versionProductNullpointerRdd.foreach(r=>{
          util.insert(sqlInsert,"20160607-20160613",r._2,r._3,r._1,"NPE",new JLong(r._4),new JLong(r._5))
        })
        versionProductAllRdd.foreach(r=>{
          util.insert(sqlInsert,"20160607-20160613",r._2,r._3,r._1,"All",new JLong(r._4),new JLong(r._5))
        })
