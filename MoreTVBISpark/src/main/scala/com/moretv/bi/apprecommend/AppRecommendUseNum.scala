...
import com.moretv.bi.common.PrevueVVUV._
  ...
  override def execute(args: Array[String]) {
    ParamsParseUtil.parse(args) match {
      case Some(p) => {
        ...
        val df = DataIO.getDataFrameOps.getDF(sc, p.paramMap, MORETV, LogTypes.APP_RECOMMEND)
        val resultRDD = df.select("date", "event", "userId", "appSid")
        ...
        userNum.foreach(x => {
          util.insert(sql, new Integer(x._1._1), new Integer(x._1._2), x._1._3, x._1._4, x._1._5, x._1._6, x._1._7,
