  ...
  override def execute(args: Array[String]) {
    ...
    ParamsParseUtil.parse(args) match {
      case Some(p) => {
        ...
        val resultRDD = DataIO.getDataFrameOps.getDF(sc, p.paramMap, MORETV, LogTypes.HOMEACCESS)
          .filter("event = 'enter'").select("date", "accessArea", "accessLocation", "userId")
          .map(e => (e.getString(0), e.getString(1), e.getString(2), e.getString(3)))
          .map(e => (getKeys(e._1, e._2, e._3), e._4))
          .filter(e => e._1._5 != null)
