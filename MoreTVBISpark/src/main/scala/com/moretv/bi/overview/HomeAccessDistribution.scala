  ...
  override def execute(args: Array[String]) {
    ...
    ParamsParseUtil.parse(args) match {
      case Some(p) => {
        ...
        val firstRDD = df.map(e => (getKeys(e._1, e._2, e._3, true), e._4))
          .filter(_ != null)
        val secondRDD = df.filter(e => e._2.toInt < 5).map(e => (getKeys(e._1, "6", e._3, true), e._4))
          .filter(_ != null)
        val thirdRDD = df.map(e => (getKeys(e._1, "0", e._3, true), e._4))
          .filter(_ != null)
        val fourRDD = df.filter(e => e._2.toInt == 1).map(e => (getKeys(e._1, e._2, e._3, false), e._4))
          .filter(_ != null)
