...
/**
  ...
  */
object CollectLogMergerTemp extends SparkSetting{
         ...
         (0 until p.numOfDays).foreach(i=>{
           ...
           if(medusaFlag && moretvFlag){
             ...
             val sqlSelectMedusa = "select logType, date,datetime, logVersion, event, apkSeries, apkVersion, userId," +
               "accountId,groupId, promotionChannel, weatherCode, productModel, uploadTime, collectType,collectContent," +
               "collectClass,ip,'' as buildDate,'' as versionCode,'medusa' as flag from log_data_1"
             val sqlSelectMoretv = "select logType, date, datetime, logVersion, event,apkSeries, apkVersion, userId," +
               "accountId,groupId, promotionChannel, weatherCode, productModel, uploadTime,collectType, collectContent," +
               "'' as collectClass,'' as ip,'' as buildDate,'' as versionCode,'moretv' as flag from log_data_2"
             ...
             val sqlSelectMoretv = "select logType, date, datetime, logVersion, event, " +
               "apkSeries, apkVersion,userId,accountId,groupId, promotionChannel, weatherCode, productModel, uploadTime,collectType," +
               "collectContent,'' as collectClass,'' as ip,'' as buildDate,'' as versionCode,'moretv' as flag from log_data_2"
