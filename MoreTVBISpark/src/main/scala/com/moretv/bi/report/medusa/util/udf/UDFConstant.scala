...
object UDFConstant {
  ...
  val MoretvPageDetailInfo = Array("search","hot_jiaodian","1_hot_tag_xinwenredian","hot_zhuanti",
    ...
    "1_comic_tags_qingchun","1_comic_tags_lizhi","1_comic_tags_huanxiang","1_comic_tags_xuanyi","1_comic_tag_qita","comic_erciyuan",
  ...
  val MedusaPageDetailInfo = Array(
    ...
    "青春浪漫","励志治愈","奇幻魔法","悬疑推理","其他分类","国漫精选","名作之壁","二次元",
    ...
    "历史钩沉","公开课","前沿科技","其他分类","豆瓣高分","猫叔推荐","刑侦档案","相声小品","铁血军魂","大话汽车",
