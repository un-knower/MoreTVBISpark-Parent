...
object TempForHuaXing extends SparkSetting {
  def main(args: Array[String]) {
    ...
    val startArr = Array("2016-08-01","2016-07-01","2016-06-01", "2016-05-01", "2016-04-01", "2016-03-01", "2016-02-01", "2016-01-01",
      ...
      "2013-12-01")
    val endArr = Array("2016-08-31","2016-07-31","2016-06-30", "2016-05-31", "2016-04-30", "2016-03-31", "2016-02-29", "2016-01-31",
    ...
    (0 until 19).foreach(i=>{
      ...
      val dir = "/log/dbsnapshot/parquet/20160901/moretv_mtv_account"
